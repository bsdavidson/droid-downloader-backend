...
class RedisFileIDsTransform extends Transform {
  ...
  async _transform(chunk, encoding, callback) {
    try {
      ...
      console.log(chunk.filePath, fileID);
...
function monitorPath(path) {
  ...
  redisFileIDsTransform.pipe(redisFilesWriter);
  redisFileIDsTransform.pipe(redisFileGeosWritable);
  redisFileIDsTransform.pipe(redisFileTimesWriter);
